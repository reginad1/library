...
ActiveRecord::Schema.define(version: 2021_01_04_235911) do
  ...
  create_table "checked_out_books", force: :cascade do |t|
    ...
    t.bigint "ebook_id"
    t.bigint "user_id"
    t.index ["ebook_id"], name: "index_checked_out_books_on_ebook_id"
  ...
  add_foreign_key "checked_out_books", "ebooks"
